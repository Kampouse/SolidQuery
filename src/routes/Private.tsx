...
export const { routeData, Page } = Protected((session) => {
  ...
  return (
    ...
    <div class="flex flex-row gap-2  mt-[0.5em] md:gap-[4em]  lg:gap-[4em] ">
      <div class="flex flex-col w-fit justify-center max-w-xs p-6 shadow-md rounded-xl sm:px-12 dark:bg-gray-900 dark:text-gray-100 h-fit">
